...
// Use the POG2 dist which has rsmv bundled
...
async function extractAllActions() {
    ...
    for (const a of allActions) {
        ...
        else if (a.entityType === 'object') outputData.meta.totals.objects++;
    }
    ...
    console.log(`   Items: ${outputData.meta.totals.items}, NPCs: ${outputData.meta.totals.npcs}, Objects: ${outputData.meta.totals.objects}`);
